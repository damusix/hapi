...
import * as Somever from '@hapi/somever';
...
const symbol = Symbol('hapi-response');


const apply = function (type, options, ...message) {
...
const versionMatch = (version, range) => Somever.match(version, range, { includePrerelease: true });
...
export { symbol, apply, enable, versionMatch };
