...
const execute = async function (request) {
...
const defaults = function (method, handler, core) {
    ...
    if (typeof handler === 'object') {
        ...
        if (serverHandler.defaults) {
            _defaults = (typeof serverHandler.defaults === 'function' ? serverHandler.defaults(method) : serverHandler.defaults);
        }
    }
...
const configure = function (handler, route) {
...
const prerequisitesConfig = function (config) {
...
export { execute, defaults, configure, prerequisitesConfig };
