...
class Manager {
    ...
    async execute(method, request, options) {
        ...
        try {
            ...
            var response = await timed(operation, options);
        }
        catch (err) {
...
const timed = async function (method, options) {
...
internals.toolkit = function () {
    ...
    Toolkit.prototype.abandon = symbols.abandon;
    Toolkit.prototype.close = symbols.close;
    Toolkit.prototype.continue = symbols.continue;
...
export { reserved, symbols, Manager, timed };
